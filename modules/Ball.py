...
class Ball:
    ...
    def draw(self, screen: Screen):  # TODO: Fires at a coordinate
        ...
        colision_1 = pygame.mixer.Sound("sounds/Ball_to_wall/ball_wall1.wav")
        colision_2 = pygame.mixer.Sound("sounds/Ball_to_wall/ball_wall2.wav")
        colision_3 = pygame.mixer.Sound("sounds/Ball_to_wall/ball_wall3.wav")
        colision_4 = pygame.mixer.Sound("sounds/Ball_to_wall/ball_wall4.wav")
        colision_5 = pygame.mixer.Sound("sounds/Ball_to_wall/ball_wall5.wav")
